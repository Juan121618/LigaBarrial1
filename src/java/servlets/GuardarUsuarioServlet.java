...
public class GuardarUsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Clasificacion nuevoUsuario = new Clasificacion(0, nombre, usuario, contrasena); // Suponiendo que el ID es autogenerado
            boolean guardadoExitoso = dao.guardarClasificacion(nuevoUsuario);
