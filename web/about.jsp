...
<head>
    <title>Acerca de Liga Semillitas</title>
    <meta charset="utf-8">
    ...
    <section class="bg-success py-5">
        <div class="container">
            <div class="row align-items-center py-5">
                ...
                <p>
                    La Liga Barrial "Semillitas del Futuro" es mucho más que un torneo de fútbol. Nació en el corazón de nuestro vecindario hace más de una década con la visión de promover la inclusión, el trabajo en equipo y los valores deportivos entre los jóvenes de nuestra comunidad.
                </p>
                </div>
                <div class="col-md-4">
        ...
        <div class="container my-4">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    ...
                    <p>
                        Contamos con la mejor indumentaria para tus entrenamientos!
                    </p>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 pt-5">
                        ...
                        <ul class="list-unstyled text-light footer-link-list">
                            <li><a class="text-decoration-none" href="index.jsp">Inicio</a></li>
